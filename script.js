...
(function () {
    ...
    emojiPicker.addEventListener('emoji-click', event => {
        ...
        if (target) {
            ...
            target.focus(); target.selectionEnd = start + emoji.length;
        }
    ...
    function showPanel() {
        ...
        const panelHeight = inputPanel.offsetHeight || 380; // Use estimated height if not rendered
